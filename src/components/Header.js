        ...
        return (
            <header className="header">
                <nav className={classNames('nav', {'nav--light': white_header, 'nav--dark': white_header !== true})}>
                    <div className="nav__logo" {...((white_header || (_.get(page, 'frontmatter.layout', null) === 'product')) ? ({"data-original": withPrefix(_.get(site, 'data.config.logo_light', null))}) : null)} data-dark={withPrefix(_.get(site, 'data.config.logo_dark', null))}>
                        <Link href={withPrefix('/')}>
                            {(white_header || (_.get(page, 'frontmatter.layout', null) === 'product')) ? (
                    ...
                    <div className="nav__right">
                        ...
                        <div className="hamburger__content hamburger__content--closed" style={toStyleObj('background-image: url(\'' + withPrefix(_.get(site, 'data.config.hamburger_background_image', null)) + '\')')}>
